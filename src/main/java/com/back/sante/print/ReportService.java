...
public class ReportService {
	...
	public String exportsReport(String reportFormat) throws FileNotFoundException, JRException {
		...
		File file = ResourceUtils.getFile("classpath:Listespatients.jrxml");
		...
		if(reportFormat.equalsIgnoreCase("html")) {
			JasperExportManager.exportReportToHtmlFile(jasperPrint,path+"\\Listepatients.html");
		}
		
		if(reportFormat.equalsIgnoreCase("pdf")) {
			JasperExportManager.exportReportToPdfFile(jasperPrint,path+"\\Listespatients.pdf");
		}
